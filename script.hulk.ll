...
@.str.18371290486108036847 = private unnamed_addr constant [14 x i8] c"Hello, World!\00"
@.str.2656948393530125995 = private unnamed_addr constant [8 x i8] c"Hello, \00"
@.str.6772673295497432341 = private unnamed_addr constant [7 x i8] c"World!\00"
@.str.18367594904887238252 = private unnamed_addr constant [57 x i8] c"Probando declaracion de variables e impresion de valores\00"
@.str.4795077891475041234 = private unnamed_addr constant [13 x i8] c"hello, world\00"
@.str.3079981617190976347 = private unnamed_addr constant [77 x i8] c"Probando declaracion de variables con condicionales e impresion de su valor:\00"
@.str.11791216477823963759 = private unnamed_addr constant [21 x i8] c"Probando bucle while\00"
@.str.11981491782166917903 = private unnamed_addr constant [19 x i8] c"Probando funciones\00"
@.str.10927791226543672611 = private unnamed_addr constant [13 x i8] c"Sucesor de 0\00"
@.str.7076524042589182705 = private unnamed_addr constant [35 x i8] c"Funcion que devuelve Hello, World!\00"
@.str.8896514223479897391 = private unnamed_addr constant [13 x i8] c"Hello, World\00"
@.str.13776148551757257316 = private unnamed_addr constant [22 x i8] c"Probando recursividad\00"
@.str.14804652499555712467 = private unnamed_addr constant [28 x i8] c"n-esimo numero de fibonacci\00"
@.str.15139346759939929636 = private unnamed_addr constant [7 x i8] c"fib(5)\00"
@.str.16406953794227168406 = private unnamed_addr constant [42 x i8] c"Probando funcion con parametros dinamicos\00"
@.str.9966117268252174966 = private unnamed_addr constant [24 x i8] c"f(x,y) => Hello, World!\00"
@.str.2220808637226576873 = private unnamed_addr constant [33 x i8] c"f(a,b), donde a y b son strings.\00"
@.str.4993892634952068459 = private unnamed_addr constant [2 x i8] c"a\00"
@.str.10838281452030117757 = private unnamed_addr constant [2 x i8] c"b\00"
@.str.13948257022755890325 = private unnamed_addr constant [7 x i8] c"f(2,3)\00"
@.str.14719126552048019185 = private unnamed_addr constant [14 x i8] c"f(true,false)\00"
@.str.18400681194753865968 = private unnamed_addr constant [2 x i8] c"
\00"
@.str.7403922714100856940 = private unnamed_addr constant [70 x i8] c"Probando funcion con parametro dinamico y tipo de retorno desconocido\00"
@.str.1325321672193711394 = private unnamed_addr constant [5 x i8] c"true\00"
@.str.15311965529666649465 = private unnamed_addr constant [56 x i8] c"Probando otra funcion recursiva, suma recursiva hasta n\00"
@.str.12967422190559844114 = private unnamed_addr constant [19 x i8] c"Probando for loops\00"
@.str.13513017015980311929 = private unnamed_addr constant [18 x i8] c"El valor de i es \00"
@.str.14478384279463005517 = private unnamed_addr constant [14 x i8] c"Moviendo i a \00"
@.str.3514678595648715872 = private unnamed_addr constant [26 x i8] c"Probando concatenaciones:\00"
@.str.3658472883277130625 = private unnamed_addr constant [6 x i8] c"false\00"
@.str.13246891346092195730 = private unnamed_addr constant [6 x i8] c"Hola \00"
@.str.1982370000811760098 = private unnamed_addr constant [6 x i8] c"Mundo\00"
@.str.16215888864653804456 = private unnamed_addr constant [2 x i8] c"4\00"
@.str.4911584241595000568 = private unnamed_addr constant [7 x i8] c"Hola, \00"
@.str.10948688084552956311 = private unnamed_addr constant [7 x i8] c"Mundo!\00"
@.str.17841279762260445766 = private unnamed_addr constant [15 x i8] c"Probando tipos\00"
...
define i8* @hw() {
entry:
  ret i8* @.str.8896514223479897391
}
...
entry:
  ...
  ret i8* @.str.18371290486108036847
}
...
define i32 @main() {
entry:
  %call_0 = call double @print_string(i8* @.str.18371290486108036847)
  %bool_1 = add i1 0, 1
  ...
  %boxed_op_27 = call i8* @concat_strings(i8* @.str.2656948393530125995, i8* @.str.6772673295497432341)
  %call_28 = call double @print_string(i8* %boxed_op_27)
  %call_29 = call double @print_string(i8* @.str.18367594904887238252)
  %a_30 = alloca double
  ...
  %call_34 = call double @print_string(i8* @.str.4795077891475041234)
  ...
  %call_47 = call double @print_string(i8* @.str.3079981617190976347)
...
ifcont_51:
  ...
  %call_56 = call double @print_string(i8* @.str.11791216477823963759)
  %a_57 = alloca double
...
while_exit_60:
  %call_67 = call double @print_string(i8* @.str.11981491782166917903)
  %call_68 = call double @print_string(i8* @.str.10927791226543672611)
  %call_72 = call double @successor(double 0.000000)
  %call_73 = call double @print_double(double %call_72)
  %call_74 = call double @print_string(i8* @.str.7076524042589182705)
  %call_75 = call i8* @hw()
  %call_76 = call double @print_string(i8* %call_75)
  %call_77 = call double @print_string(i8* @.str.13776148551757257316)
  %call_78 = call double @print_string(i8* @.str.14804652499555712467)
  %call_79 = call double @print_string(i8* @.str.15139346759939929636)
  %call_94 = call double @fib(double 5.000000)
  %call_95 = call double @print_double(double %call_94)
  %call_96 = call double @print_string(i8* @.str.16406953794227168406)
  %call_97 = call double @print_string(i8* @.str.9966117268252174966)
  %call_100 = call double @print_string(i8* @.str.2220808637226576873)
  %boxed_101 = call %struct.BoxedValue* @boxString(i8* @.str.4993892634952068459)
  %boxed_102 = call %struct.BoxedValue* @boxString(i8* @.str.10838281452030117757)
  %call_103 = call i8* @f(%struct.BoxedValue* %boxed_101, %struct.BoxedValue* %boxed_102)
  %call_104 = call double @print_string(i8* %call_103)
  %call_105 = call double @print_string(i8* @.str.13948257022755890325)
  ...
  %call_110 = call double @print_string(i8* @.str.14719126552048019185)
  %bool_111 = add i1 0, 1
  ...
  %call_117 = call double @print_string(i8* @.str.18400681194753865968)
  %call_118 = call double @print_string(i8* @.str.7403922714100856940)
  %boxed_121 = call %struct.BoxedValue* @boxString(i8* @.str.1325321672193711394)
  ...
  %call_131 = call double @print_string(i8* @.str.15311965529666649465)
  %call_144 = call double @sum_to(double 100.000000)
  %call_145 = call double @print_double(double %call_144)
  %call_146 = call double @print_string(i8* @.str.12967422190559844114)
  %i_150 = alloca double
...
for_body_148:
  ...
  %boxed_159 = call %struct.BoxedValue* @boxString(i8* @.str.13513017015980311929)
  ...
  %boxed_165 = call %struct.BoxedValue* @boxString(i8* @.str.14478384279463005517)
...
for_exit_149:
  %call_169 = call double @print_string(i8* @.str.18400681194753865968)
  %call_170 = call double @print_string(i8* @.str.3514678595648715872)
  %bool_171 = add i1 0, 1
  %boxed_173 = call %struct.BoxedValue* @boxBoolean(i1 %bool_171)
  %boxed_174 = call %struct.BoxedValue* @boxString(i8* @.str.3658472883277130625)
  ...
  %bool_176 = add i1 0, 1
  %boxed_178 = call %struct.BoxedValue* @boxString(i8* @.str.3658472883277130625)
  ...
  %boxed_op_181 = call i8* @concat_strings(i8* @.str.13246891346092195730, i8* @.str.1982370000811760098)
  %call_182 = call double @print_string(i8* %boxed_op_181)
  %boxed_184 = call %struct.BoxedValue* @boxString(i8* @.str.16215888864653804456)
  ...
  %call_192 = call i8* @concat(i8* @.str.4911584241595000568, i8* @.str.10948688084552956311)
  %call_193 = call double @print_string(i8* %call_192)
  %call_194 = call double @print_string(i8* @.str.17841279762260445766)
  ret i32 0
}
